# -*- coding: utf-8 -*-
"""object_oriented_Egen.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/13Akx52UATfBOal9JtigIA_QsAHogemUi
"""
...
class Etl:
  ...
  def get_data(self, url):
    try:
      ...
      print("Sorry! Could not retrieve anything on {}".format(self.url))
      return None
...
# loading data into sqlite3
  def load_database(self, df):
    ...
    conn = Etl.create_connection(database)
    for d,df2 in df:
      print(d,df2)
...
def main():
      ...
      with concurrent.futures.ThreadPoolExecutor() as executor:
        c_data = executor.map(get.get_data, serviceurl)
      County_data = []
      for data in c_data:
        County_data.append(data)
      dataframe = get.set_data(County_data)
      get.load_database(dataframe)
